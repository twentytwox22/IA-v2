...
const addStudent = "INSERT INTO students (name, email, year, house, isRegistered, studentNumber) VALUES ($1,$2,$3,$4,$5, $6)"; //45:28
const removeStudent ="DELETE FROM students WHERE studentNumber = $1"; //55:15
const updateStudent = "UPDATE students SET year = $1 WHERE studentNumber = $2"; //1:04:55
